...
// Modified by Batchas/Scrotum Lab, April 2023
// Adapted Gritty-Grids code (the Sonic Insurgence mod) to have a third mode (clock div) 
// that was found in TheSlowGrowth code.
